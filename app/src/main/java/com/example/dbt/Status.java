...
public class Status
{
    ...
    String score;
    public Status(){}
    public Status(String username, String typeofgame, String score)
    {
        username = this.uname;
        typeofgame = this.tog;
        score = this.score;
    ...
    public static void setSimonScore(int simonScore) { SimonScore = simonScore; }

    public static int getMemoryScore() { return MemoryScore; }
    public static void setMemoryScore(int memoryScore) { MemoryScore = memoryScore; }

    public static int getTriviaScore() { return TriviaScore; }
    public static void setTriviaScore(int triviaScore) { TriviaScore = triviaScore; }

    public static int getIsekaiScore() { return IsekaiScore; }
    public static void setIsekaiScore(int isekaiScore) { IsekaiScore = isekaiScore; }

    public static int getDumbScore() { return DumbScore; }
    public static void setDumbScore(int dumbScore) { DumbScore = dumbScore; }
